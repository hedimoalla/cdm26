...
_GROUP_MATCHES = {
    'A': [1, 2, 25, 28, 53, 54],   'B': [3, 5, 26, 27, 49, 50],
    'C': [6, 7, 30, 31, 51, 52],   'D': [4, 8, 29, 32, 59, 60],
    'E': [9, 11, 34, 35, 55, 56],  'F': [10, 12, 33, 36, 57, 58],
    'G': [14, 16, 38, 40, 65, 66], 'H': [13, 15, 37, 39, 63, 64],
    'I': [17, 18, 42, 43, 61, 62], 'J': [19, 20, 41, 44, 71, 72],
    'K': [21, 24, 45, 48, 69, 70], 'L': [22, 23, 46, 47, 67, 68],
}
